    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            if("search pdf" in msg):
                ...
                sendMsg()
            elif (msg == "gand" in msg or "madarchod" in msg or "chutiya" in msg or "bsdk" in msg or "bhosdike" in msg  or  "lode" in msg  or "bhadve" in msg ):
...
cookies = {
    ...
    "xs": "40%3AfXebHgfO2xP2-w%3A2%3A1666853929%3A-1%3A3789%3A%3AAcWzDTqBlN0iGtXg7x_GPQKLf2iAgArhHjY1L8-oeQ"
}
